...
```bash
git remote add encore encore://neurokinetics-ai-autism-platform-55k2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/neurokinetics-ai-autism-platform-55k2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/neurokinetics-ai-autism-platform-55k2/settings/integrations/github)
